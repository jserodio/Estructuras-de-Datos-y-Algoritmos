...
public class PruebaSimpleLinkedList {
	
	public static void visualizarNodos(UnorderedSimpleLinkedList<Integer> l) {
	...
	public static void main(String[] args)  {
		...
		UnorderedSimpleLinkedList<Integer> l =new UnorderedSimpleLinkedList<Integer>();
		l.addToRear(1);
		l.addToRear(3);
		l.addToRear(6);
		l.addToRear(7);

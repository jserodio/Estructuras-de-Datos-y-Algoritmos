...
public class PruebaOrderedSimpleLinkedList {	
		
		public static void main(String[] args)  {
			
			OrderedSimpleLinkedList<Integer> l = new OrderedSimpleLinkedList<Integer>();
			l.add(1);
			l.add(3);
			l.add(6);
			l.add(7);
			...
			OrderedSimpleLinkedList<Persona> l2 = new OrderedSimpleLinkedList<Persona>();
